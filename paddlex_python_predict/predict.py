...
print("Loading model...")
model = pdx.load_model(r'C:\Users\csuil\paddlex_workspace\P0010-T0020_export_model\inference_model\inference_model')
print("Model loaded.")

im = cv2.imread('test.jpg')
im = im.astype('float32')

result = model.predict(im, nms_score_threshold=0.5)
